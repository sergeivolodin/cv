...
\address{sergei.volodin@epfl.ch \href{http://sergeivolodin.github.io}{\img{./img/www.png}}
	\href{http://linkedin.com/in/sergeivolodin/}{\img{./img/li.png}} \href{http://github.com/sergeivolodin}{\img{./img/gh.png}}
	\href{https://www.facebook.com/sergeivolodinepfl}{\img{./img/fb.png}} +41 78 732 01 34}
...
%		\item Worked on the Power Flow Feasibility problem with Prof. Anatoly Dymarsky, Dr. Elena Gryazina, and Prof. Boris T. Polyak
		\item Designed and implemented \faExternalLink~\href{https://github.com/sergeivolodin/CertificateCutting}{the algorithm} for cutting convex parts of the image of a quadratic map.
