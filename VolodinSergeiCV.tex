...
\name{Sergei VOLODIN (aka Sergia)}
\address{\mylink~\href{https://sergia-ch.github.io}{sergia-ch.github.io} / Sch\"{a}chenstrasse 11, 8048 Z\"{u}rich, Switzerland \emoji{flag-ch}}
...
\address{sergia94 at protonmail dot com \href{http://sergia-ch.github.io}{\emoji{internet}}
	\href{https://twitter.com/sergeivolodinch}{\img{./img/twitter.png}}
...
\begin{rSection}{Work experience}
    ...
    \begin{rSubsection}{\mylink~\href{https://faveforfans.com}{Fave For Fans}}{Sep 2021 -- present}{Platform dedicated to passionate fans, Z\"{u}rich, Switzerland \emoji{flag-ch}}{Software Engineer}
        \myitem {\bf Responsible} for parts of the backend, data validation, and CI/CD. The backend uses TypeScript, and an OpenAPI specification, serverless workers and a distributed database.
