...
%\contourlength{1pt}
%\ontourumber{10}
\photo{./photo/me-blue.jpeg}
\address{\mylink~\href{https://sergeivolodin.github.io}{sergeivolodin.github.io} / Kasernenstrasse 29, 8004 Z\"{u}rich, Switzerland \emoji{flag-ch}}
\address{Birth date: 3rd of October 1994 (\FPtrunc\myage{\myage}{0}\myage\,years), Russian \emoji{flag-ru}}
\address{sergei.volodin.ch at gmail dot com \href{https://sergeivolodin.github.io}{\emoji{internet}}
	\href{http://linkedin.com/in/sergeivolodin/}{\imgd{li}} \href{http://github.com/sergeivolodin}{\imgd{gh}}
	\emoji{telephone}  +41 77 958 45 98}
%\twocolumn
...
\definecolor{hrulecolor}{RGB}{50, 50, 50}
\newcommand{\myitem}{\item[\textcolor{gray}{\Huge\raisebox{-2pt}{$\cdot$}}]}

\begin{rSection}{Abstract}

Software engineer and young scientist with with experience in research and development in industry, academia and startups. Have a Swiss degree. Looking for a vibrant team to work on creative projects.

\begin{center}
\logo{Logo_EPFL.pdf} {\large ,\,}
{\LARGE
\google
} {\large ,\,}
...
\myitem Thesis \mylink~\href{https://sergeivolodin.github.io/causality-simplicity/CauseOccam_Learning_Interpretable_Abstract_Representations_in_Reinforcement_Learning_Environments_via_Model_Sparsity.pdf}{"CauseOccam: Learning Interpretable Abstract Representations in
...
\begin{rSection}{Skills}
	...
	\item \myboldq{Languages:} \emoji{flag-us} English: \mylink~\href{https://sergeivolodin.github.io/epfl/TOEFL.pdf}{TOEFL iBT \mybold{113}/120}, {\small \emoji{flag-fr} French: A1, \emoji{flag-ru} Russian: native}
\end{rSection}
...
\begin{rSection}{Work and research experience}
	\begin{rSubsection}{\mylink~\href{https://faveforfans.com}{Fave For Fans \emoji{fave}}}{Software Engineer}{Platform dedicated to passionate fans, Z\"{u}rich, Switzerland \emoji{flag-ch}}{Sep 2021 -- May 2022}
		...
		\myitem \mybold{Proposing} and discussing ways to create \mylink~\href{https://sergeivolodin.github.io/fave/direct_sharing.png}{more \mybold{ethical and democratic social media} sharing mechanisms}, organizing voting in the team to discuss proposals ("mini \mylink~\href{https://en.wikipedia.org/wiki/Stakeholder_theory}{Stakeholder Capitalism}")
	...
	\begin{rSubsection}{\mylink~\href{http://tournesol.app}{Tournesol \emoji{sunflower}}}{Co-founder\&ML engineer}{Non-profit designing better recommender systems, Lausanne, Switzerland \emoji{flag-ch}}{May 2020 -- May 2021}
...
%\hspace{5cm}\dotfill\hspace{5cm}
\,

% full color
\def\imgpref{}
\definecolor{extrasG}{RGB}{50,  150,  50}
\vspace{30pt}
\begin{center}
EXTRAS
%	\mybold{
...
\begin{rSection}{Extra Experience}
	\begin{rSubsection}{\mylink~\href{https://research.swisscom.ai/}{Swisscom Digital Lab} \emoji{flag-ch}}{Thesis student}{Lausanne, Switzerland}{Sep 2020 -- Nov 2020}
