...
\begin{rSection}{Work experience}
    ...
    \begin{rSubsection}{\mylink~\href{https://faveforfans.com}{Fave For Fans}}{Sep 2021 -- May 2022}{Platform dedicated to passionate fans, Z\"{u}rich, Switzerland \emoji{flag-ch}}{Software Engineer}
        \myitem First full-time coder. {\bf Responsible} for the backend development with microservices (Cloudflare Workers) with TypeScript, data validation, and CI/CD. The backend uses TypeScript, and an OpenAPI specification, serverless workers and a distributed database.
        \myitem {\bf Research} into ways of obtaining data from third-party services with privacy guarantees
        \myitem {\bf Conducted} analysis of the database to create better ranking algorithms
    \end{rSubsection}
