...
\begin{rSection}{Skills}
	...
	\item {\color{gray}\bf Scientific programming:} {\bf Keras, TensorFlow,} {\bf PyTorch,} ray/tune/rllib, tf-agents, scikit-learn, Brian 2, MATLAB, Mathematica, R
	\item {\color{gray}\bf Programming languages:} Python, C/C++, Java, TypeScript, {\small Scala, nasm, C\#, AVR C++}
	\item {\color{gray}\bf Frameworks:} Qt/QML, Django, {\small Android Studio, OpenGL/GLSL, Unity 3D, Blender, React.js}
	...
	\item {\color{gray}\bf Software development:} {\bf agile} software development (Scrum), CI/CD, debugging, design patterns, concurrent and distributed systems, {\small TCP/IP networking, AVR microcontrollers, Arduino platform, team and project management in small startups}
...
\begin{rSection}{Research experience}			  
	\begin{rSubsection}{EPFL, Laboratory for Computational Neuroscience \emoji{flag-ch}}{Master's Thesis student}{Lausanne, Switzerland}{Oct 2020 -- Apr 2021}
		\myitem Designed \mylink~\href{https://github.com/sergia-ch/causality-disentanglement-rl}{an algorithm} with {\bf Python 3, Pytorch and ray} based on the \mylink~"\href{https://arxiv.org/abs/1709.08568}{Consciousness Prior}" proposal that finds a simple causal model of an RL environment in the general case from pixels. The project is a continuation of my Google Research internship (see below)
...
\begin{rSection}{Work experience}
    ...
    \begin{rSubsection}{\mylink~\href{https://faveforfans.com}{Fave For Fans \emoji{fave}}}{Sep 2021 -- May 2022}{Platform dedicated to passionate fans, Z\"{u}rich, Switzerland \emoji{flag-ch}}{Software Engineer}
        ...
        \myitem {\bf Proposing} and discussing ways to create more ethical and democratic social media sharing mechanisms, organizing voting in the team to discuss proposals ("mini \mylink~\href{https://en.wikipedia.org/wiki/Stakeholder_theory}{Stakeholder Capitalism}")
	...
	\begin{rSubsection}{\mylink~\href{http://tournesol.app}{Tournesol \emoji{sunflower}}}{May 2020 -- May 2021}{Startup designing better recommender systems, Lausanne, Switzerland \emoji{flag-ch}}{}
		\myitem {\bf Co-founded a startup} working on contributor-driven collaborative recommender systems
		...
		\myitem {\bf Responsible} as well for system administration (Debian), (partially) front-end development with {\bf React.js} and parts of algorithm design
