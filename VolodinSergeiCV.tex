...
\item \faExternalLink~\href{http://sergeivolodin.github.io}{Website}
...
%		\item Worked on the Power Flow Feasibility problem with Prof. Anatoly Dymarsky, Dr. Elena Gryazina, and Prof. Boris T. Polyak
		\item Designed and implemented the algorithm for cutting convex parts of the image of a quadratic map. \faExternalLink~\href{https://github.com/sergeivolodin/CertificateCutting}{Repository}
...
\item \faExternalLink~\href{http://web.archive.org/web/20170224094223/http://rl.deephack.me/}{DeepHack.RL} hackathon (Deep RL for Atari games), MIPT, Moscow, Russia, 2017. 4th place. \faExternalLink~\href{https://github.com/sergeivolodin/deephack.rl}{Code}
\item Sixteen interuniversity programming olympiad, Vologda, 2013\\\hfill {\em \url{http://olympiads.vologda-uni.ru/interuni/}}
...
\begin{rSubsection}{\faExternalLink~\href{http://escapecontrol.ru/index_en.html}{EscapeControl}}{Jul 2015 -- Feb 2016}{Software Engineer, C++ (Atmel AVR, Linux)}{Moscow, Russia}
	\item Created \faExternalLink~\href{http://habr.ru/p/258585/}{system architecture} for the real-world escape room games. \faExternalLink~\href{http://demo:demo@ec3.pagekite.escapecontrol.ru}{Demo}
