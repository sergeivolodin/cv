...
\begin{rSection}{Work experience}
    ...
    \begin{rSubsection}{\mylink~\href{https://faveforfans.com}{Fave For Fans}}{Sep 2021 -- May 2022}{Platform dedicated to passionate fans, Z\"{u}rich, Switzerland \emoji{flag-ch}}{Software Engineer}
        \myitem {\bf Responsible} for the backend development with microservices (Cloudflare Workers) with TypeScript, an ArangoDB-based database, automatic data schema validation, and CI/CD with integration tests. First full-time engineer in the company.
