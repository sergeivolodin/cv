...
\myitem Thesis \mylink~\href{https://github.com/sergeivolodin/ms-thesis/releases/download/v1.0/thesis_volodin.pdf}{"CauseOccam: Learning Interpretable Abstract Representations in
...
\begin{rSection}{Skills}
	...
	\item {\color{grayheading}\bf Languages:} \emoji{flag-us} English: TOEFL iBT {\bf 113}/120, {\small \emoji{flag-fr} French: A1, \emoji{flag-ru} Russian: native}
\end{rSection}
...
\begin{rSection}{Work experience}
	...
	\begin{rSubsection}{\mylink~\href{http://tournesol.app}{Tournesol \emoji{sunflower}}}{May 2020 -- present}{Startup designing better recommender systems, Lausanne, Switzerland \emoji{flag-ch}}{}
		...
		\myitem {\bf Responsible} for \mylink~\href{https://github.com/tournesol-app/tournesol}{back-end Machine Learning engineering, the API server}
		\myitem {\bf Responsible} as well for system administration, (partially) front-end development
	\end{rSubsection}
