...
\item Bachelor's degree im Computer Science
\item GPA: {\bf 4.84}/5
\end{rSubsection}
\end{rSection}
...
\begin{rSection}{Research experience}
	...
	\begin{rSubsection}{Swiss Federal Institute of Technology in Lausanne (EPFL), Distributed Computing Laboratory}{Research Assistant}{Lausanne, Switzerland}{Sep 2018 -- present}
		\item Working on the Why neurons fail theory to extend it
		\item Experiments using Keras and Tensorflow to test the theory
	\end{rSubsection}
