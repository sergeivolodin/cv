...
\name{Sergei VOLODIN}
\address{Chemin du Devin 47C, 1012-Lausanne, Switzerland}
...
\address{sergei.volodin@epfl.ch \href{http://sergeivolodin.github.io}{\img{./img/www.png}}
	\href{http://linkedin.com/in/sergeivolodin/}{\img{./img/li.png}} \href{http://github.com/sergeivolodin}{\img{./img/gh.png}} \phone +41 78 732 01 34}
%\twocolumn
...
\hspace{-1em}
\begin{rSubsection}{\logo{Logo_EPFL.pdf} Swiss Federal Institute of Technology in Lausanne (EPFL)}{}{Lausanne, Switzerland}{Sep 2017 -- Apr 2021}
...
\end{rSubsection}
%\hrule
\begin{rSubsection}{\logo{mipt.png} Moscow Institute of Physics and Technology}{}{Moscow, Russia}{June 2017}
...
\begin{rSection}{Work experience}
	...
	\begin{rSubsection}{\mylink~\href{http://tournesol.app}{Tournesol}}{May 2020 -- present}{Startup designing better recommender systems, Lausanne, Switzerland}{}
		\myitem {\bf Co-created a startup} working on expert-driven recommender systems
...
\begin{rSection}{Projects}
		\begin{rSubsection}{Learning Interpretable Abstract Representations in Reinforcement Learning via Model Sparsity}{2020}{EPFL semester/thesis project, advised by Dr. Johanni Brea and Prof. Wulfram Gerstner}{}
